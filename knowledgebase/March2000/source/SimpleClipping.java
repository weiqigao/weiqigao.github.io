...
public class SimpleClipping implements Printable {
    ...
    public SimpleClipping(String stringToPrint) {
    ...
    public int print(Graphics g, PageFormat pf, int pageIndex) throws PrinterException {
        ...
        g2.draw(new Rectangle(100,175,200,30));
        ...
        g2.translate(0, 0);
        g2.setClip(100,275,201,51);

        g2.setColor(Color.gray);
        g2.draw(new Rectangle(100,275,200,30));
    ...
    public static void main(String[] args) {
        ...
        // Specify the painter
        if (args.length == 0) {
            painter = new SimpleClipping();
        } else {
            painter = new SimpleClipping(args[0]);
        }
        ...
        new PrintPreview(book, "Print Preview - SimpleClipping");
    }
}